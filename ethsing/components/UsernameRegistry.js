...
const UsernameRegistry = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <main className="rounded-xl bg-white text-blue-500 mx-72 outline outline-offset-2 outline-blue-300 shadow-2xl">
              ...
              <>
                <div className="px-16">
                  <input
                    ...
                    name="username"
                    type="text"
                    className="outline outline-offset-2 outline-blue-300 rounded-lg my-4 font-mono text-md font-semibold text-blue-500"
                    value={username}
                ...
                <div className="flex justify-center items-center my-4 mx-8">
                  <div className="rounded-2xl bg-gray-100 outline outline-offset-2 outline-blue-300">
                    <div className="text-2xl my-2 mx-4 cursor-pointer font-mono font-semibold text-black hover:text-blue-500">
