...
export default function profile()   
{
  ...
  <div className=' flex justify-center'>
    <div className=' text-3xl font-mono font-semibold text-blue-500 my-6'>
        Your Posts
    </div>
  </div>
  ...
  <div className=' bg-white shadow-2xl text-white mx-20 my-2 rounded-xl outline outline-offset-2 outline-blue-300 outline-width:4px '>
