...
export default function Home () {
  ...
  return (
    ...
    <main className='rounded-xl bg-white  text-blue-500 mx-72 outline outline-offset-2 outline-blue-300 outline-width:8px; shadow-2xl'>
...
<input className='text-blue-500 rounded-md px-8 flex w-10/12 outline outline-offset-2 outline-blue-300 outline-width:4px; ' type='text' placeholder='Hey,there !'/>


<div className='flex justify-center items-center my-4 mx-6'>
<div className='rounded-2xl bg-gray-200 outline outline-offset-2 outline-blue-300 outline-width:4px'>
<div className=' text-2xl my-2 mx-3 cursor-pointer font-mono font-semibold text-black hover:text-blue-500'>
